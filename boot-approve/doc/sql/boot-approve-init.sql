...
CREATE TABLE `approve_instance`  (
  ...
  `last_modify_time` datetime(0) NULL DEFAULT NULL COMMENT '最后修改时间【通常记录撤销原因或者审批后系统反写的时间】',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '审批实例记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of approve_instance
-- ----------------------------
INSERT INTO `approve_instance` VALUES (19, 'APPROVED', 55, '用来测试', 100, '2022-03-18 01:47:26', 1004, 89, '生产部审批', '3,4', '测试审批', NULL, NULL);
...
CREATE TABLE `approve_node_record`  (
  ...
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '审批节点名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 90 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '审批节点记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of approve_node_record
-- ----------------------------
INSERT INTO `approve_node_record` VALUES (87, 'APPROVED', 19, 42, 'DIRECT', '技术部审批，检测技术规范', 1, '技术部审批');
INSERT INTO `approve_node_record` VALUES (88, 'APPROVED', 19, 43, 'DIRECT', '采购部检查物料', 2, '采购部审批');
INSERT INTO `approve_node_record` VALUES (89, 'APPROVED', 19, 44, 'COUNTERSIGN', '生产部排期', 3, '生产部审批');
...
CREATE TABLE `approve_running_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 91 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '审批运行记录表， 具体记录了每一条审批信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of approve_running_record
-- ----------------------------
INSERT INTO `approve_running_record` VALUES (87, 87, '技术部审批', 0, 1, '通过', 'APPROVED', 'name,desc,xxx', 1, 0, 0, 0, '1,2', 0, 0, 0, '2022-03-18 01:47:26', '2022-03-18 01:47:49');
INSERT INTO `approve_running_record` VALUES (88, 88, '采购部审批', 0, 2, '通过', 'APPROVED', 'name,desc,xxx', 1, 0, 0, 0, '1,2', 0, 0, 0, '2022-03-18 01:47:26', '2022-03-18 01:48:52');
INSERT INTO `approve_running_record` VALUES (89, 89, '生产部审批', 0, 3, '通过', 'APPROVED', 'name,desc,xxx', 1, 0, 0, 0, '1,2', 0, 0, 0, '2022-03-18 01:47:26', '2022-03-18 01:49:21');
INSERT INTO `approve_running_record` VALUES (90, 89, '生产部审批', 0, 4, '通过', 'APPROVED', 'name,desc,xxx', 2, 0, 0, 0, '1,2', 0, 0, 0, '2022-03-18 01:47:26', '2022-03-18 01:50:09');
